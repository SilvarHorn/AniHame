  ...
  return (
    <div className="flex flex-col w-full relative group/trending">
      ...
      <div className="relative w-full">
        <button 
          onClick={() => scroll(-400)} 
          className="absolute left-0 top-1/2 -translate-y-1/2 -ml-4 z-10 p-2 bg-black/60 text-white rounded-full opacity-0 group-hover/trending:opacity-100 hover:bg-primary hover:text-black transition-all hidden sm:block"
        >
          <ChevronLeft size={24} />
        </button>
        ...
        <button 
          onClick={() => scroll(400)} 
          className="absolute right-0 top-1/2 -translate-y-1/2 -mr-4 z-10 p-2 bg-black/60 text-white rounded-full opacity-0 group-hover/trending:opacity-100 hover:bg-primary hover:text-black transition-all hidden sm:block"
        >
